        ...
        function setTime(i) {
            ...
            directionsService.getDistanceMatrix(request, function (response, status) {
                if (status == google.maps.DistanceMatrixStatus.OK) {
                    ...
                    //time[i] = temp;
                    //console.log(time);
                   // $("#resultsTable").tablesorter({ sortList: [[2, 0]] })
        ...
        function getRoute(i) {
            if (typeof (Storage) !== "undefined") {
                ...
                var request = {
                    ...
                    destination: locList[i].geometry.location,
                    travelMode: google.maps.TravelMode.DRIVING,
                    durationInTraffic: true,
                    unitSystem: google.maps.UnitSystem.IMPERIAL
                };
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Emergency Assistance</a>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="col-lg-12">
                        <div class="input-group">
                            ...
                            <asp:TextBox ID="autocomplete" runat="server" CssClass="form-control" placeholder="Enter City..."></asp:TextBox>
                            <span class="input-group-btn">                                
                                <input type="button" class="btn btn-primary" onclick="search()" value="Search Location"/>
                    ...
                    <div class="col-lg-12">
                        <div id="map-canvas" style="width: 100%; height: 525px;"></div>
                    </div>
                </div>
                <div class="col-lg-6">
